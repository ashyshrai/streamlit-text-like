  ...
  public render = (): React.ReactNode => {
    ...
    return (
          ...
          {text}
            ...
            <IconButton onClick={this.onClickedLike} style={{paddingTop:'0px',paddingBottom:'0px'}}>
              <ThumbUpIcon color={this.state.hasClickedLike?'primary':'disabled'}/>
            </IconButton>

            <IconButton onClick={this.onClickedDislike} style={{paddingTop:'0px',paddingBottom:'0px'}} >
